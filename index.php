<?php include 'header.php';?>
					...
					<div class="banner-btmg1">
						...
						<form  class="banner_form">
							<div class="sec-left">
								...
								<input placeholder="Street Address or ZIP code " name="from_address" id="from-input" type="text">
								<span id="from_err"></span>
							</div>
							<div class="sec-right">
								<label class="contact-form-text">Moving To</label>
								<input type="text" id="to-input" name="to" placeholder="Your Designation">
								<span id="to_err"></span>
							</div>
							<input type="button" id="submit" value="Get a Quote">
						</form>
					</div>
				</div>
			</div>
	...
	<!-- <section class="testimonials py-md-5">
		<div class="container py-4 mt-2">
			...
			<p class="tit text-center mx-auto text-white">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eius eum inventore consectetur dolorum, voluptatum possimus
				temporibus vel ab, nesciunt quod!</p>
	...
	<!-- <section class="wthree-row w3-about py-md-5">
		<div class="container py-4 mt-2">
			...
			<p class="tit text-center mx-auto">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eius eum inventore consectetur dolorum, voluptatum possimus
				temporibus vel ab, nesciunt quod!</p>
	...
	<!-- <section class="stats py-md-5">
		<div class="container py-4 mt-2">
			...
			<div class="row inner_w3l_agile_grids-1 pt-4 mt-md-4">
				<div class="col-sm-4 Eswar_stats_left w3_counter_grid">
					<p class="counter">1,546</p>
					<h3>Satisfied Clients</h3>
					<h6>Pure satisfaction</h6>
				</div>
				<div class="col-sm-4 Eswar_stats_left w3_counter_grid1">

					<p class="counter">14,345</p>
					<h3>Successful Shippings</h3>
					<h6>Shipping</h6>
				</div>
				<div class="col-sm-4 Eswar_stats_left w3_counter_grid2">
